...
namespace JadedBelles.Util.UI
{
    ...
    public class BreathingImage : MonoBehaviour
    {
        ...
        /// <summary>
        /// Nudge the breathing phase to peak inhale on demand — useful when a companion widget
        /// reacts to a win and we want the portrait to swell for a beat instead of catching it
        /// mid-exhale. Purely visual.
        /// </summary>
